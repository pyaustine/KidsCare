# KidsCare
KidsCare is a ML tool that help detect Autism in Toddlers. The ML is integrated to a WhatsApp bot as well as a web application.
...
```sh
$ https://github.com/sphinx-austin/autism-spectrum-disorder-project.git
```
